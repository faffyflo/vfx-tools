...
echo checking images with these extensions: !extensions!
...
for %%e in (%extensions%) do (
    ...
    for %%f in (*%%e) do (
        ...
        for /l %%d in (5,-1,2) do (
            :: this is a bit sneaky, because basename is not defined yet this if statement will return TRUE the first time. But then once we go to extractFrame and find a file then we'll define it and this if statement will return false the next time we loop through it. 
            if "!bsaename!"=="" (
